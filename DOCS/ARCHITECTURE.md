...
**Связанные документы:** `MASTYR_SPISIFICATYON.MD`, `AGENTS.md`  
...
### 7.2. Матрица критичности

| Уровень | Пример | Действие системы |
|---|---|---|
| Низкий | Напоминание, сбор статуса | Разрешённая автоматизация |
| Средний | Проект поручения, внутренний отчёт | Согласование руководителем направления |
| Высокий | Письмо заказчику, изменение бюджета | Согласование профильным специалистом и директором |
| Критический | Платёж, договор, изменение проекта, безопасность | Обязательное согласование генеральным директором и ответственным специалистом |
...
1. Сначала прочитать `MASTYR_SPISIFICATYON.MD`, `AGENTS.md` и `ARCHITECTURE.md`.
