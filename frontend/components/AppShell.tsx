...
const NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/pto", label: "Исполнительная документация", icon: "documents" },
    ],
  },
  {
...
const TITLES: Record<string, { title: string; sub: string }> = {
  ...
  "/pto": { title: "Исполнительная документация ПТО", sub: "Версионирование, инженерное согласование и контроль обязательного комплекта" },
  "/notifications": { title: "Уведомления", sub: "Персональные in-app уведомления системы" },
